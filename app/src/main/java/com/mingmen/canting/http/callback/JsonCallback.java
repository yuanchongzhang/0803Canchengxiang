...
import com.mingmen.canting.model.LzyResponse;
import com.mingmen.canting.model.SimpleResponse;
import com.mingmen.canting.util.Convert;
   ...
   /*     request.headers("header1", "HeaderValue1")//
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        if (rawType == Void.class) {
            ...
            //有数据类型，表示有data
            Log.d("dkdkdkdkdk",jsonReader.toString());

            Gson gson=new Gson();
            LzyResponse lzyResponse=new LzyResponse();
            lzyResponse=gson.fromJson(response.body().toString(),LzyResponse.class);
            Log.d(lzyResponse.msg,"dkdkdkkdkdkddk");
