package com.mingmen.canting.http.adapter;
...
import com.mingmen.canting.http.cache.CacheManager;
import com.mingmen.canting.http.cache.CacheMode;
import com.mingmen.canting.http.callback.AbsCallback;
import com.mingmen.canting.http.callback.AbsCallbackWrapper;
import com.mingmen.canting.http.exception.OkGoException;
import com.mingmen.canting.http.model.HttpHeaders;
import com.mingmen.canting.http.model.Response;
import com.mingmen.canting.http.request.BaseRequest;
import com.mingmen.canting.http.utils.HeaderParser;
import com.mingmen.canting.http.utils.HttpUtils;
        ...
        rawCall.enqueue(new okhttp3.Callback() {
            ...
            public void onResponse(okhttp3.Call call, okhttp3.Response response) throws IOException {
                ...
                try {
                    ...
                    Log.d("dkdkdk",response.toString());
