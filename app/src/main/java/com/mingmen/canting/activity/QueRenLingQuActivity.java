 ...
 */
public class QueRenLingQuActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_querenlingqu);
    ...
    private void bindView() {
        ...
        mAdapter = new QueRenlingAdapter(mShowModels);
...
//        mRecyclerView.addItemDecoration(decoration);
        ...
        mAdapter.setOnitemClickLintener(new QueRenlingAdapter.OnitemClick() {
            @Override
            public void onItemClick(int position) {

                Log.d("kdkdkdkf", mShowModels.get(position).getCompanyName() + "");
//                setResult(1, new Intent().putExtra("value", "data1"));
                Intent intent = new Intent(QueRenLingQuActivity.this, LoginActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.layout_close:
                ...
                Intent intent = new Intent(QueRenLingQuActivity.this, RegisterActivity.class);
