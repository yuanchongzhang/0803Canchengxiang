...
import com.mingmen.canting.adapter.BohuiyuanAdapter;
 ...
 */
public class BohuiYuanyinActivity extends Activity {
    ...
    private BohuiyuanAdapter mAdapter;
    String string;
    String attrs = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bohuiyuanyin);
    ...
    private void bindView() {
        ...
        mAdapter = new BohuiyuanAdapter(mShowModels);
...
//        mRecyclerView.addItemDecoration(decoration);
        ...
        mAdapter.setOnitemClickLintener(new BohuiyuanAdapter.OnitemClick() {
            @Override
            public void onItemClick(int position) {

                Log.d("kdkdkdkf", mShowModels.get(position).getCompanyName() + "");
//                setResult(1, new Intent().putExtra("value", "data1"));
                Intent intent = new Intent(BohuiYuanyinActivity.this, LoginActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.layout_close:
                ...
                Intent intent = new Intent(BohuiYuanyinActivity.this, RegisterActivity.class);
