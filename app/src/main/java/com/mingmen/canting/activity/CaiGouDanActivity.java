...
public class CaiGouDanActivity extends AppCompatActivity implements OnTabSelectListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* for (String title : mTitles) {
        ...
        mFragments.add(Daicaigouragment.getInstance(mTitles[0]));
...
//        tabLayout_2.setMsgMargin(2, 8, 5);
    ...
    public void onTabSelect(int position) {
        Toast.makeText(CaiGouDanActivity.this, position + "", Toast.LENGTH_LONG).show();
    }
