...
public class CaiGouActivity extends AppCompatActivity implements OnTabSelectListener {
...
//        tabLayout_2.showMsg(5, 5);
    ...
    public void onTabSelect(int position) {
        Toast.makeText(CaiGouActivity.this,position+"",Toast.LENGTH_LONG).show();
    }
