...
public class LoginFilterAdapter extends RecyclerView.Adapter<LoginFilterAdapter.ContactsViewHolder> {

    private List<LoginFilterBean.DataBean> contacts;
    private static final String TAG = "ContactsAdapter";
    private OnitemClick onitemClick;   //定义点击事件接口
    public LoginFilterAdapter(List<LoginFilterBean.DataBean> contacts) {
    ...
    public void onBindViewHolder(ContactsViewHolder holder, int position) {
        LoginFilterBean.DataBean contact = contacts.get(position);
        if (onitemClick != null) {
