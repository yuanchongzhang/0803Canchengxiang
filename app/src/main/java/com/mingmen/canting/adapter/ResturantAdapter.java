...
public class ResturantAdapter extends RecyclerView.Adapter<ResturantAdapter.ContactsViewHolder> {

    private List<RestaurantBean.DataBean> contacts;
    private static final String TAG = "ContactsAdapter";
    private OnitemClick onitemClick;   //定义点击事件接口
    public ResturantAdapter(List<RestaurantBean.DataBean> contacts) {
    ...
    public void onBindViewHolder(ContactsViewHolder holder, int position) {
        RestaurantBean.DataBean contact = contacts.get(position);
        if (onitemClick != null) {
