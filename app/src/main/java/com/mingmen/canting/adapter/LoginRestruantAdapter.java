...
public class LoginRestruantAdapter extends RecyclerView.Adapter<LoginRestruantAdapter.ContactsViewHolder> {

    private List<LoginBean.DataBean> contacts;
    private static final String TAG = "ContactsAdapter";
    private OnitemClick onitemClick;   //定义点击事件接口
    public LoginRestruantAdapter(List<LoginBean.DataBean> contacts) {
