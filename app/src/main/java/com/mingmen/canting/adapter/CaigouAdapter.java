...
public class CaigouAdapter extends BaseExpandableListAdapter {
    ...
    public CaigouAdapter(List<StoreInfo> groups, Map<String, List<GoodsInfo>> childrens, Context mcontext) {
        this.groups = groups;
    ...
    public int getChildrenCount(int groupPosition) {
        ...
        Log.d("dkdkdk", childrens.get(groupId).size() + "");
...
//        return childs;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mcontext, R.layout.item_caigougroup, null);
    ...
    List<GoodsInfo> childs;

    @Override
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        final ChildViewHolder childViewHolder;
        if (convertView == null) {
            convertView = View.inflate(mcontext, R.layout.item_caigou_product, null);
...
//        GoodsInfo child = childs.get(childPosition);
        ...
        childs = childrens.get(groups.get(groupPosition).getId());
        ...
        if (childs.size() == 1) {
            childViewHolder.layout_child.setBackground(mcontext.getResources().getDrawable(R.drawable.shape_caigouproduct));
        } else {
            if (childs.size() > 1) {
                if (childPosition == 0) {
                    childViewHolder.layout_child.setBackground(mcontext.getResources().getDrawable(R.drawable.shape_caigouproduct3));
                } else if (childPosition == childs.size() - 1) {
                    childViewHolder.layout_child.setBackground(mcontext.getResources().getDrawable(R.drawable.shape_caigouproduct));
                } else {
                    childViewHolder.layout_child.setBackground(mcontext.getResources().getDrawable(R.drawable.shape_caigouproduct2));
                }
            }
        }
