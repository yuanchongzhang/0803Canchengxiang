...
public class LoginAdapter extends RecyclerView.Adapter<LoginAdapter.ContactsViewHolder> {

    private List<LoginReturnBean.DataBean> contacts;
    private static final String TAG = "ContactsAdapter";
    private OnitemClick onitemClick;   //定义点击事件接口
    public LoginAdapter(List<LoginReturnBean.DataBean> contacts) {
    ...
    public void onBindViewHolder(ContactsViewHolder holder, int position) {
        LoginReturnBean.DataBean contact = contacts.get(position);
        if (onitemClick != null) {
