...
public class BohuiyuanAdapter extends RecyclerView.Adapter<BohuiyuanAdapter.ContactsViewHolder> {

    private List<LoginBean.DataBean> contacts;
    private static final String TAG = "ContactsAdapter";
    private OnitemClick onitemClick;   //定义点击事件接口
    public BohuiyuanAdapter(List<LoginBean.DataBean> contacts) {
    ...
    public ContactsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layaout_item_bohuiuyuan, null);
