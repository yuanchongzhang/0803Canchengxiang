...
package com.mingmen.canting.zhexian.charts;
...
import com.mingmen.canting.zhexian.components.XAxis.XAxisPosition;
...
import com.mingmen.canting.zhexian.highlight.ChartHighlighter;
import com.mingmen.canting.zhexian.highlight.Highlight;
import com.mingmen.canting.zhexian.interfaces.dataprovider.BarLineScatterCandleBubbleDataProvider;
import com.mingmen.canting.zhexian.interfaces.datasets.IBarLineScatterCandleBubbleDataSet;
import com.mingmen.canting.zhexian.jobs.AnimatedMoveViewJob;
import com.mingmen.canting.zhexian.jobs.AnimatedZoomJob;
import com.mingmen.canting.zhexian.jobs.MoveViewJob;
import com.mingmen.canting.zhexian.jobs.ZoomJob;
import com.mingmen.canting.zhexian.listener.BarLineChartTouchListener;
import com.mingmen.canting.zhexian.listener.OnDrawListener;
import com.mingmen.canting.zhexian.renderer.XAxisRenderer;
import com.mingmen.canting.zhexian.renderer.YAxisRenderer;
import com.mingmen.canting.zhexian.utils.MPPointD;
import com.mingmen.canting.zhexian.utils.MPPointF;
import com.mingmen.canting.zhexian.utils.Transformer;
import com.mingmen.canting.zhexian.utils.Utils;
...
//        mXAxis.setLabelCount(6, true);
//        mXAxis.setDrawScale(true);
...
/**********上面是源码的 下面是自己的方法***********************/
        ...
        mAxisLeft.setDrawZeroLine(false); // draw a zero line
        mAxisLeft.setZeroLineColor(Color.GRAY);
        //绘制X轴刻度
        mXAxisRenderer.renderScaleLines(canvas);
        //绘制Y轴刻度
        mAxisRendererLeft.renderScaleLines(canvas);
...
//        mAxisLeft.setDrawZeroLine(true); // draw a zero line
//        mAxisLeft.setZeroLineColor(Color.GRAY);
//        mAxisRendererLeft.renderScaleLines(canvas);
//
//        mAxisRendererLeft.drawZeroLineScale(canvas, mXAxis);
        mXAxis.setDrawScale(false);
//是否绘制X轴线
        mXAxis.setDrawAxisLine(false);

        mAxisLeft.setZeroLineWidth(1f);
