...
public class DingDanFragment3 extends Fragment implements CheckListener {
...
//        mSortDetailFragment.setListener(this);
    ...
    public static DingDanFragment3 getInstance(String title) {
        DingDanFragment3 sf = new DingDanFragment3();
        sf.getData = title;
