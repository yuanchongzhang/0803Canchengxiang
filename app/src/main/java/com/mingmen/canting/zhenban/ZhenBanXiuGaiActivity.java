...
public class ZhenBanXiuGaiActivity extends AppCompatActivity implements OnTabSelectListener {
        ...
        HttpResponse.getShop(token, "0", "2", new StringCallback(this) {
            ...
            public void onSuccess(String s, Call call, Response response) {
                ...
                for (int i = 0; i < shopBean.getData().size(); i++) {
                    mFragments.add(DingDanXiuGaiFragment.getInstance(s));
                }
    ...
    public void onTabSelect(int position) {
        Toast.makeText(ZhenBanXiuGaiActivity.this, position + "", Toast.LENGTH_LONG).show();
    }
...
//            return mTitles[position];
    ...
    public void canldaCreate() {
        ...
        pvTime = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                Toast.makeText(ZhenBanXiuGaiActivity.this, getTime(date), Toast.LENGTH_SHORT).show();
    ...
    public void popWindowCreate() {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(ZhenBanXiuGaiActivity.this, 4);
        recyclerView.setLayoutManager(gridLayoutManager);
        myLabelAdapter = new MyLabelAdapter(ZhenBanXiuGaiActivity.this);
        ...
        myLabelAdapter.setOnItemClickListener(new MyLabelAdapter.OnItemClickListener() {
            ...
            public void onItemClickListener(View view, int pos, List<String> myLiveList) {
                ...
                Toast.makeText(ZhenBanXiuGaiActivity.this, myLiveList.get(pos) + "", Toast.LENGTH_SHORT).show();
                popupWindow.dismiss();

            }
        });
        DividerItemDecoration divider = new DividerItemDecoration(ZhenBanXiuGaiActivity.this, DividerItemDecoration.VERTICAL);
        divider.setDrawable(ContextCompat.getDrawable(ZhenBanXiuGaiActivity.this, R.drawable.custom_divider));
